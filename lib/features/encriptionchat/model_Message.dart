...
class ModelMessageBubble extends StatefulWidget {
  const ModelMessageBubble(this.message, this.isMe, this.userImage, this.time,
      {required this.key});
  ...
  @override
  _ModelMessageBubbleState createState() => _ModelMessageBubbleState();
}

class _ModelMessageBubbleState extends State<ModelMessageBubble> {
  bool secure = true;
  String secureMessage = '';
  Color myMessage = buttonColor;
